        ...
        return Theme(
            ...
            switchTheme: SwitchThemeData(
              trackColor: WidgetStateProperty.resolveWith<Color>((
                ...
                if (states.contains(WidgetState.selected)) {
                  return Colors.green; // Green background when enabled
                }
                return Colors.grey; // Gray background when disabled
              }),
          ...
          child: SettingsList(
            ...
            lightTheme: SettingsThemeData(
              ...
              settingsSectionBackground: Colors.white.withAlpha(
                (0.8 * 255).toInt(),
              ),
            ),
              ...
              SettingsSection(
                ...
                tiles: [
                  ...
                  SettingsTile.switchTile(
                    ...
                    initialValue: Provider.of<GlobalStatus>(
                      context,
                      listen: true,
                    ).audionotifications,
                    leading: const Icon(Icons.circle_notifications),
                    title: Text(
                      AppLocalizations.of(context)!.audionotifications,
                    ),
                  ),
                ],
              ),
              SettingsSection(
                ...
                tiles: [
                  ...
                  SettingsTile(
                    ...
                    description: Text(
                      AppLocalizations.of(context)!.lightordark,
                    ),
